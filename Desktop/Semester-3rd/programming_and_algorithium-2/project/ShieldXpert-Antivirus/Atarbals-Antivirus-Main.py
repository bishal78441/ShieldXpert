...
class Settings(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_4.bind("<Button-1>", lambda e: callback("http://localhost/site1/index.html"))
        ...
        button_5.bind("<Button-1>", lambda e: callback("https://github.com/bishal78441"))
        ...
        button_7.bind("<Button-1>", lambda e: callback("https://github.com/bishal78441"))
