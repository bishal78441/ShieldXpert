...
update_button = Button(
    ...
    bd=0,
    cursor="hand2",
    command=update_password  # Linking the button to the function
)
update_button.place(x=300, y=445, width=70, height=35) 
...
def open_signup_page():
    subprocess.Popen(['python', r'C:\Users\asus\Desktop\Semester-3rd\programming_and_algorithium-2\project\ShieldXpert-Antivirus\Python Tkinter Modern GUI login and sign up form\register_page.py'])

switchSignup.config(command=open_signup_page)
